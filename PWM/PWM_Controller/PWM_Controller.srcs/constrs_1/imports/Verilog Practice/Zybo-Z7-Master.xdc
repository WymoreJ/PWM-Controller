...
##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { iReset[0] }]; #IO_L19N_T3_VREF_35 Sch=sw[0]
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { oPWM[0] }]; #IO_L23P_T3_35 Sch=led[0]
